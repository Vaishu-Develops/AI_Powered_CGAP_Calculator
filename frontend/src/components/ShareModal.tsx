        ...
        try {
            ...
            const canvas = await html2canvas(wrappedRef.current, {
                ...
                onclone: (clonedDoc) => {
                    ...
                    if (el) {
                        el.style.borderRadius = '24px'; // Ensure radius is preserved in clone
                    }
                }
            });
                    ...
                    <div className="px-8 mt-6 mb-6">
                        <div className="flex bg-bg-card-alt rounded-2xl p-1.5 border border-border/40 shadow-inner">
                            ...
                            <button
                                ...
                                className={`flex-1 py-3 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all flex items-center justify-center gap-2 ${tab === 'wrapped' ? 'bg-primary text-white shadow-lg' : 'text-text-muted hover:bg-primary hover:text-white hover:shadow-md active:scale-95'}`}
                            >
                    ...
                    <div className="px-8 pb-8">
                        {tab === 'quick' ? (
                            ...
                            <div className="space-y-4">
                                ...
                                >
                                    {/* Background gradient - Using simplified linear gradient for better html2canvas rendering */}
                                    <div
                                    ...
                                    <div className="relative z-10 flex flex-col justify-between h-full">
                                        ...
                                        <div className="space-y-3">
                                            {topGrade && (
                                                <div className="flex items-center justify-between rounded-xl px-4 py-2.5 border" style={{ backgroundColor: 'rgba(255, 255, 255, 0.05)', borderColor: 'rgba(255, 255, 255, 0.05)' }}>
